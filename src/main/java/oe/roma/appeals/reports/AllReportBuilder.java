...
public class AllReportBuilder extends AbstractJExcelView {
    ...
    protected void buildExcelDocument(Map<String, Object> model,
        ...
        sheet.addCell(new Label(0,2,"",cellFormat1));
        ...
        sheet.addCell(new Label(12, start, "В-дь надіслана у термін, дн.",normal));
        sheet.addCell(new Label(13, start, "Працівник канцелярії",normal));
        for(int i=0;i<14;i++)
        ...
        for (Appeal appeal : list) {
            ...
            sheet.addCell(appeal.getResponse_term()== null ? new Blank (12,rowCount,normal) :new Number(12, rowCount, appeal.getResponse_term(),normal));
            sheet.addCell(new Label(13, rowCount, appeal.getEmployee(),normal));
            rowCount++;
        }
    }
}
